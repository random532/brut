CC?=cc
CFLAGS+= -rdynamic -fcommon -I${LOCALBASE}/include/glib-2.0/ -I${LOCALBASE}/lib/glib-2.0/include -I${LOCALBASE}/include/gdk-pixbuf-2.0/ -I${LOCALBASE}/include/cairo -I${LOCALBASE}/include/pango-1.0 -I${LOCALBASE}/include/gtk-3.0 -I${LOCALBASE}/include/atk-1.0
